...
ActiveRecord::Schema.define(version: 20151012033221) do
  ...
  create_table "friends", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "a_friend",     default: false
  end
  ...
  add_index "reviews", ["user_id", "company_id"], name: "index_reviews_on_user_id_and_company_id", unique: true, using: :btree
